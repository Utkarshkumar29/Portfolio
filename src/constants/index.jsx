...
export const workExperiences = [
  {
    ...
    pos: 'React.js / Next.js Developer',
    duration: 'Sep 2024 - Present',
    point_1: "Diagnosed and fixed high-impact production bugs across React.js and Next.js applications, ensuring smooth deployments on Vercel and DigitalOcean.",
    point_2: "Refactored core components to improve readability and reusability, reducing technical debt and boosting site performance by ~15%.",
    point_3: "Collaborated with design teams to implement ~50% of UI/UX updates, improving responsiveness and cross-device performance.",
    point_4: "Led the end-to-end development of 'Leaders Access', architecting reusable components and scalable layouts for a production web platform.",
    point_5: "Streamlined Firebase integrations and CI/CD workflows to enable faster, safer releases across staging and production environments.",
    icon: '/assets/ef.svg',
    animation: 'victory',
  },
  {
    id: 2,
    name: 'Employee Forums',
    pos: 'React.js / Next.js Intern',
    duration: 'Mar 2024 - Aug 2024',
    point_1: "Resolved numerous frontend bugs and UI inconsistencies, contributing to improved user experience and application stability.",
    point_2: "Assisted in refactoring legacy components to align with modern React and Next.js best practices.",
    point_3: "Implemented major UI and responsiveness improvements using Tailwind CSS and MUI, following Figma designs.",
    point_4: "Supported deployment processes on Vercel and DigitalOcean, gaining hands-on experience with real-world production releases.",
    icon: '/assets/ef.svg',
    animation: 'clapping',
  },
  {
    ...
    point_1: "Developed responsive frontends optimized for mobile views, improving mobile traffic engagement by 20%.",
    point_2: "Developed a seamless connection with Spotify's Web API for music streaming capabilities, leading to an increase of over 200 new app downloads per month.",
    point_3: "Established organized folder structures for scalable code management, improving team efficiency by 30%.",
    point_4: "Adapted to changing project requirements by enhancing functionality, resulting in a 15% improvement in user satisfaction.",
